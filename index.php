...
if (isset($_POST['submit'])){
        ...
        /*fin del if*/ else{
                    ?>
                               <script>alert('Su mensaje NO fue enviado.');</script>
                  <?php
      ...
      <div class="row">
        ...
        <div class="col l8 m8 s7">
            ...
            <div class="row card-panel z-depth-2">
               <form class="contact-form" method="post" action="index.php" enctype="multipart/form-data" id="formulario">
                    ...
                    <div class="input-field col s6">
                        <input id="tel" type="text" class="validate" id="t" name="tel">
                    ...
                    <div class="row">
                        <div class="col l6">
                            <button type="submit" class="waves-effect disabled waves-light btn btn-contacto" id="send" name="submit"><i class="material-icons left" id="sub">send</i>Enviar</button>
                        </div>
                        <div class="col l6">
                            <button class="waves-effect disabled waves-light  btn btn-contacto" id="btn"><i class="material-icons left">clear_all</i>Limpiar</button>
                        </div>
                    </div>
